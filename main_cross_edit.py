...
parser.add_argument('--n-labeled', type=int, default=16,
...
if __name__ == '__main__':
    ...
    for seed in pbar_seed:
        ...
        directory = './{}_result/ssl_method_{}/sub2sub/original_parse/labeled_16/run_{}/'.format(args.dataset, args.method, seed+1)
        # directory = './{}_result/ssl_method_{}/sub2sub/mcl/labeled_12/run_{}/'.format(args.dataset, args.method, seed+1)
